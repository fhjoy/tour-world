parcelRequire = (function(e, r, t, n) {
...
})(
  {
      ...
      function(require, module, exports) {
        ...
        var e = function(e) {
          ...
          var o = new mapboxgl.Map({
              container: 'map',
              style:
                'mapbox://styles/faisalschmedtmann/cjvi9q8jd04mi1cpgmg7ev3dy',
              scrollZoom: !1
            }),
    ...
    zIVT: [
      ...
      { './helpers/bind': 'nb4k', 'is-buffer': 'ZH5x' }
    ],
    TOXd: [
      function(require, module, exports) {
        'use strict';
    ...
    Focm: [
      function(require, module, exports) {
        ...
        var j = document.getElementById('map'),
          ...
          n = document.getElementById('book-tour');
        if (j) {
          var a = JSON.parse(j.dataset.locations);
          (0, e.displayMap)(a);
        }
        c &&
          ...
          d && d.addEventListener('click', s.logout),
          m &&
